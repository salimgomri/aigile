      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-[300px_1fr] gap-12 items-center max-w-6xl mx-auto">
          ...
          <div>
            ...
            <div className="text-xl text-primary font-semibold mb-2">{t('about-role')}</div>
            <div className="text-lg text-gray-600 italic mb-6">{t('about-founding')}</div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6 hover:shadow-xl transition-all duration-300">
              <h4 className="text-xl font-bold text-primary mb-4">{t('about-credentials-title')}</h4>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
              <h4 className="text-xl font-bold text-primary mb-4">{t('about-contact-title')}</h4>
              <div className="space-y-3">
                ...
                <a href="mailto:Salim.gomri@gmail.com" className="flex items-center gap-3 hover:text-primary transition-colors">
