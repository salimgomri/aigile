...
export default function FloatingFeedbackButton() {
  ...
  return (
    <>
      {/* Floating Button - bottom left, below coaching if any */}
      <button
        onClick={() => setIsOpen(true)}
        className="fixed bottom-8 left-8 z-40 group"
        aria-label={t['feedback-float']}
      >
        <div className="relative flex items-center space-x-2 px-4 py-3 bg-aigile-navy/90 hover:bg-aigile-navy border border-aigile-gold/30 text-aigile-gold rounded-full shadow-lg hover:shadow-lg transition-all duration-300">
