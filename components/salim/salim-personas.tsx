...
function getPersonas(yearsExperience: number) {
  return [
    {
      icon: Users,
    ...
    },
    {
      ...
      text: `${yearsExperience} ans de terrain concentrés. 24 pièges que les formations ne mentionnent jamais. Le système S.A.L.I.M. comme cadre d’ensemble.`,
    },
  ] as const
}

export function SalimPersonas() {
  const personas = getPersonas(getSalimYearsExperience())
