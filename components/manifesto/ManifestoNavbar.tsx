...
export function ManifestoNavbar() {
  ...
  const navItems =
    language === 'fr'
      ? [
          { id: 'values', label: 'Valeurs', href: '#values' },
          { id: 'principles', label: 'Principes', href: '#principles' },
          { id: 'about', label: 'Auteur', href: '#about' },
          { id: 'book', label: 'Le livre', href: '/#hero' },
        ]
      : [
          { id: 'values', label: 'Values', href: '#values' },
          { id: 'principles', label: 'Principles', href: '#principles' },
          { id: 'about', label: 'Author', href: '#about' },
          { id: 'book', label: 'The book', href: '/#hero' },
        ]
